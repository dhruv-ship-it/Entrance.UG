...
import { BarChart3, Bell, BookOpenCheck, BookOpenText, ChevronDown, CircleUserRound, ClipboardList, CreditCard, GraduationCap, LayoutDashboard, LogOut, Menu, ScrollText, ShieldCheck, UsersRound } from 'lucide-react';
...
const navigation = [
  ...
  { to: '/student/analysis', label: 'Analysis', icon: BarChart3 },
